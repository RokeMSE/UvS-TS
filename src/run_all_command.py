...
commands = [
    ...
    # "python unlearn_logic_2.py --enable-cuda --type stcgn --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA --forget-set /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA/forget_set.json",
    ...
    ### UNLEARN NODE
    # Baseline PEMS-BAY
    "python run_baselines.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY --run-retrain",
    # Baseline METR-LA
    "python run_baselines.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA --run-retrain",

    # Unlearn 2 PEMS-BAY
    "python unlearn_2.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY",

    # Unlearn 2 METR-LA
    "python unlearn_2.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA",

    # Unlearn 3 PEMS-BAY
    "python unlearn_3.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY",

    # Unlearn 3 METR-LA
    "python unlearn_3.py --enable-cuda --unlearn-node --node-idx 0 --all --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA",

    # Unlearn logic 2 PEMS-BAY model STGCN
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type stgcn --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY",

    # Unlearn logic 2 METR-LA model STGCN
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type stcgn --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA",

    # Unlearn logic 2 PEMS-BAY model STGAT
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type stgat --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY",

    # Unlearn logic 2 METR-LA model STGAT
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type stgat --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA",

    # Unlearn logic 2 PEMS-BAY model GWNET
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type gwnet --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/PEMS-BAY --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/PEMS-BAY",

    # Unlearn logic 2 METR-LA model GWNET
    "python unlearn_logic_2.py --enable-cuda --unlearn-node --node-idx 0 --type gwnet --input /user/cs.aau.dk/tungkvt/hung_quyen/Data/METR-LA --model /user/cs.aau.dk/tungkvt/hung_quyen/Model/METR-LA",
]
